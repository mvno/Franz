...
* Handle situation where all brokers are unavailable. This fix throws an exception when this happens, and will continue working when brokers are available again.
### 0.0.4
* Initial release
